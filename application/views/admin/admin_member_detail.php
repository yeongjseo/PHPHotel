...
<div class="container">
 	...
 	<div class="col-md-8 col-md-offset-2">
 		...
 		<form class="form-horizontal" method="post" action="<?=CONTEXT.'/admin/member_detail'?>" id="formMember" onSubmit="return checkSubmit()">
		...
		$.ajax({
			...
			success: function(data, status) {
				if (data.result == "success") {
					frm.attr("action", "<?=CONTEXT.'/admin/member_delete'?>");
					frm.submit();
				}
				else {
